<template>
  <div class="relative flex" ref="dropdownRef">
    <button className="text-[#98A6AD] hover:text-[#64748B]" @click="dropdownOpen = !dropdownOpen">
      <svg
    ...
    <div
      v-show="dropdownOpen"
      className="absolute right-0 top-full z-40 w-40 space-y-1 rounded-sm border border-stroke dark:border-strokedark bg-white p-1.5 shadow-default dark:bg-boxdark"
    >
      <button
        className="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm hover:bg-[#EFF4FB] dark:hover:bg-[#313D4A]"
      >
        <svg
          className="fill-current"
          width="16"
